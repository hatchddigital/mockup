!function(e, t) {
    ...
    r(l, [], function() {
        ...
        return function(r, i) {
            ...
            return i.contentStyles.push(I + '{min-height: 134px;}' + I + " div.mce-resizehandle {" + "position: absolute;" + "border: 1px solid black;" + "background: #FFF;" + "width: 5px;" + "height: 5px;" + "z-index: 10000" + "}" + I + " .mce-resizehandle:hover {" + "background: #000" + "}" + I + " img[data-mce-selected], hr[data-mce-selected] {" + "outline: 1px solid black;" + "resize: none" + "}" + I + " .mce-clonedresizable {" + "position: absolute;" + (n.gecko ? "" : "outline: 1px dashed black;") + "opacity: .5;" + "filter: alpha(opacity=50);" + "z-index: 10000" + ";} body#content {overflow-y: scroll !important;} html { overflow-y: scroll !important;}"),
            i.on("init", function() {
        ...
        t.translate = function(e) {
            ...
            v = n(), u({
                ...
                var n = [], r = c(g.settings.block_formats || "Paragraph=p;Address=address;Pre=pre;Header 2=h2;Header 3=h3;Header 4=h4;Header 5=h5;Header 6=h6");
...
tinymce.PluginManager.add("advlist", function(t) {
    ...
    a = e("UL", t.getParam("advlist_bullet_styles", "default")),
    t.addButton("numlist", {
        type: "splitbutton",
...
tinymce.ThemeManager.add("modern", function(e) {
    ...
    }, h = "undo redo | styleselect | bold italic | bullist numlist link image";
